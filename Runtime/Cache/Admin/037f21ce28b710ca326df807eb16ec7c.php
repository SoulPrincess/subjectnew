            ...
            <div class="layadmin-user-login-main">
                ...
                <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
                        ...
                        <div class="layui-row">
                            ...
                            <div class="layui-col-xs5">
                                <div style="margin-left: 10px;">
                                    <img src="<?php echo U('Index/verify');?>" title="看不清，换一张" class="layadmin-user-login-codeimg" id="LAY-user-get-vercode"><br><br>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="layui-trans layui-form-item layadmin-user-login-other">
                        <a href="<?php echo U('Index/register');?>" class="layadmin-user-jump-change layadmin-link">注册帐号</a>
                    </div>
                </div>
            </div>
    </div>
    ...
    <script>
        $(function(){
            $('#LAY-user-get-vercode').click(function(){
                $('#LAY-user-get-vercode').attr('src',"/Admin/Index/verify/random/"+Math.random());//点击事件改变图片地址
            });
        });
