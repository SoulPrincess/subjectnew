                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show layui-form" lay-filter="save1">
                        ...
                        <div class="layui-form-item Ontheborder">
                            <div class="layui-input-inline ">
                                <button class="layui-btn" id="save1"  lay-filter="save1" lay-submit="save1"> 保存</button>
                            </div>
                        </div>
                    </div>
                    <div class="layui-tab-item layui-form" lay-filter="save2">
                        ...
                        <div class="layui-card-body" pad15="">
                            <div class="layui-form" lay-filter="">
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline empty">
                                        <label class="layui-form-labelStatic"></label>
                                        <a href="javascript:void(0);" id="setStai1" onclick="sendtest()">发送测试</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item Ontheborder">
                            <div class="layui-input-inline ">
                                <button class="layui-btn" lay-filter="save2" lay-submit="save2"> 保存</button>
                            </div>
                        </div>
                    </div>
                    <div class="layui-tab-item">
                        ...
                        <div class="layui-card-body layui-form" pad15="" lay-filter="save3">
                            ...
                            <div class="layui-form-item Ontheborder">
                                <div class="layui-input-inline ">
                                    <button class="layui-btn" lay-filter="save3" lay-submit="save3"> 保存</button>
                                </div>
                            </div>
                        </div>
                    </div>
