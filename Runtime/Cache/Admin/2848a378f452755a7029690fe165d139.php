                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline ccc">
                            <input type="text" name="oldtext" id="name" placeholder="请输入" autocomplete="off" class="layui-input" lay-verify="required" value="<?php echo ($datainfo['original']); ?>">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline ccc">
                            <input type="text" name="newtext"  placeholder="请输入" autocomplete="off" class="layui-input" value="<?php echo ($datainfo['newtext']); ?>">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline ccc">
                            <input type="text" name="title" placeholder="请输入" autocomplete="off" class="layui-input" value="<?php echo ($datainfo['titile']); ?>">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline ccc">
                            <input type="text" name="Chained"  placeholder="请输入" autocomplete="off" class="layui-input" value="<?php echo ($datainfo['chained']); ?>">
                        </div>
                    </div>
                </div>
...
<script>
        layui.use('form', function () {
            ...
            form.on('submit(service_save)', function (data) {
                ...
                $.ajax({
                    url: "<?php echo U('marketing/anchorupdate');?>",
                    data: formData,
                    type: 'post',
