                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select id="product_type" name="product_type" lay-filter="product_type" >
                                </select>
                            </div>
                    </div>
                </div>
                ...
                <div class="layui-form layui-card-header layuiadmin-card-header-auto" lay-filter="app-content-list">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline ccc">
                                <input type="text" name="productenname" placeholder="请输入" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline raning">
                                <input type="text" name="productpv" value="0" autocomplete="off" class="layui-input small">
                            </div>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="radio" name="attribute" value="1" title="推荐" checked><div class="layui-unselect layui-form-radio "><i class="layui-anim layui-icon"></i><div>推荐</div></div>
                                <input type="radio" name="attribute" value="2" title="置顶"><div class="layui-unselect layui-form-radio revel"><i class="layui-anim layui-icon"></i><div>置顶</div></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-form" lay-filter="">
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="img[big]" value="" autocomplete="off" class="layui-input" id="LAY_avatarUpload1">
                            </div>
                            <button type="button" class="layui-btn layui-btn-primary" id="LAY_avatarUploadbig">
                                <i class="layui-icon"></i>上传图片
                            </button>
                            <input class="layui-upload-file" type="file" accept="undefined" name="img[big]">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="img[sm]" value="" autocomplete="off" class="layui-input" id="LAY_avatarUpload2">
                            </div>
                    ...
                    <div class="layui-form" lay-filter="">
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline ccc">
                                    <input type="text" placeholder="请输入"  class="layui-input" name="seotitle">
                                </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline ccc">
                                <input type="text" placeholder="请输入" class="layui-input" name="keywords">
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <textarea placeholder="请输入内容"  class="layui-textarea textA" name="description"></textarea>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline ccc">
                                    <input type="text" placeholder="请输入" name="tag" class="layui-input">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline ccc">
                                <input type="text" placeholder="请输入" name="staticname" class="layui-input">
                            </div>
                    ...
                    <div class="layui-form" lay-filter="">
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="UpdateDate" id="UpdateDate"  placeholder="yyyy-mm-dd 00:00:00" class="layui-input" value="<?php echo date('Y-m-d H:i:s',time());?>">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="ReleaseDate" id="ReleaseDate"  placeholder="yyyy-mm-dd 00:00:00" class="layui-input release" value="<?php echo date('Y-m-d H:i:s',time());?>">
    ...
    $(function () {
        ...
        layui.use(['form', 'layedit'], function () {
            ...
            form.on('submit(consult-present)', function (data) {
                ...
                $.ajax({
                    url: "<?php echo U('product/productadd');?>",
                    data: formData,
                    type: 'post',
