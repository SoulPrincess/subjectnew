        ...
        <div class="layadmin-tabsbody-item layui-show">
            ...
            <div class="layui-card">
                <div class="layui-card-header layuiadmin-card-header-auto">
                    <button <?php echo authcheck('addmanagement');?> class="layui-btn layuiadmin-btn-tags" id="btn-add">添加一级分类</button>
        ...
        layui.config({
            ...
            var renderTable = function () {
                    treetable.render({
                        treeColIndex: 1,
                        treeSpid:0,
                        url:"<?php echo U('content/articlemanagement');?>",
                        treeIdName: 'id',
                        treePidName: 'pid',
            ...
            table.on('tool(consult_type)', function (obj) {
                ...
                if (layEvent === 'del') {
                    layer.confirm('你确定删除数据吗？此操作不能撤销！', function (index) {
                        //向服务端发送删除指令
                        layui.$.post(
                            "<?php echo U('content/delmanagement');?>",
                            {
                                p_id: data.c_id,
                                f_id: data.pid
                            },
                    ...
                    layui.$.post(
                        "<?php echo U('content/updatemanagement');?>",
                        {
                            p_id: data.c_id,
                            f_id: data.pid,
                            Name: data.name,
                    ...
                    layui.$.post(
                        "<?php echo U('content/statusmanagement');?>",
                        {
                            p_id: data.c_id,
                            f_id: data.pid,
                            off: data.display
