...
<head>
    ...
    <link rel="stylesheet" href="../../../../../sfkj/sfkj-07-02/css/bootstrap.css">
</head>
    ...
    <script>
        $(function(){
            $('#LAY-user-get-vercode').click(function(){
                $('#LAY-user-get-vercode').attr('src',"/Admin/Login/verify/random/"+Math.random());//点击事件改变图片地址
            });
        });
                ...
                success:function(res){
                    if(res.status=='0'){
                        layer.msg(res.info,{time:1000},function(){
                            ...
                            $('#LAY-user-get-vercode').attr('src',"/Admin/Login/verify/random/"+Math.random());
