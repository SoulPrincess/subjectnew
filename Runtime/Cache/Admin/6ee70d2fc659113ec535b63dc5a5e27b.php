    ...
    <form class="layui-form" action="">
        <div class="layui-card">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" id="change_type">
                            <select id="consult_lg" lay-filter="consult_lg" name="consult_lm"></select>
                        </div>
                        <div class="layui-input-inline">
                            <select id="consult_sm" name="consult_sm" lay-filter="consult_sm"></select>
                        </div>
                        <!--<div class="layui-form-mid "><a href="/Consult/Type">分类管理</a></div>-->
                    </div>
            ...
            <div class="layui-form layui-card-header layuiadmin-card-header-auto" lay-filter="app-content-list">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label">英文标题/备注</label>
                        <div class="layui-input-inline ccc">
                            <input type="text" name="enTitle" placeholder="请输入" autocomplete="off" class="layui-input">
                        </div>
                    </div>
            ...
            <div class="layui-card-body" pad15="">
                ...
                <div class="layui-form" lay-filter="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="Recommend" id="Recommend" value="0" title="是" checked="checked"><div class="layui-unselect layui-form-radio"><i class="layui-anim layui-icon"></i><div>是</div></div>
                            <input type="radio" name="Recommend" value="1" title="否"><div class="layui-unselect layui-form-radio "><i class="layui-anim layui-icon"></i><div>否</div></div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">更新时间</label>
                        <div class="layui-input-inline">
                            <input type="text" name="UpdateDate" id="UpdateDate" autocomplete="off"placeholder="yyyy-mm-dd 00:00:00" class="layui-input" value="<?php echo date('Y-m-d H:i:s',time());?>">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="ReleaseDate" id="ReleaseDate" autocomplete="off" placeholder="yyyy-mm-dd 00:00:00" class="layui-input" value="<?php echo date('Y-m-d H:i:s',time());?>">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline layui-btn-container" style="width: auto;">
                            <button type="button" class="layui-btn layui-btn-primary" src="" id="LAY_avatarUpload">
    ...
    $(function () {
        layui.use('upload', function () {
            ...
            var uploadInst = upload.render({
                ...
                , done: function (res) {console.log(res.data.src);
                    //如果上传失败
                    if (res.status == 0) {
        ...
        layui.use(['form', 'layedit'], function () {
            ...
            form.on('submit(consult-present)', function (data) {
                ...
                $.ajax({
                    url: "<?php echo U('content/articleadd');?>",
                    data: formData,
                    type: 'post',
