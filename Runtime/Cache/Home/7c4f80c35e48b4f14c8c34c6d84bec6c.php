...
<div class="parallax-content baner-content baner-content-product">
    <div class="container">
        <div class="row text-content-location  wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
            ...
            <div class="col-xs-12 col-sm-6 product">
                <img src="/Public/home/img/subpage/pro-erweima.png" alt="">
            </div>
        </div>
...
<!--Product traceability lifecycle monitoring flow chart-->
<section class="page-section">
    <div class="container">
        <div class="text-content  wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
            <h3 class="text-content-color h3-fear"><?php echo ($productf1['productname']); ?></h3>
            <p class="text-content-color p-fear"><?php echo ($productf1['productenname']); ?></p>
        </div>
        <div class="solution wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
            <div class="col-xs-12 flow">
                <img src="<?php echo ($productf1['coverimg']); ?>" alt="">
            </div>
...
<!--Product traceability lifecycle monitoring flow chart-->
<!--Characteristics of traceability platform-->
<section id="traceability" class="page-section">
        <div class="container">
            <div class="text-content wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
                <h3 class="text-content-color h3-fear"><?php echo ($productf2['productname']); ?></h3>
                <p class="text-content-color p-fear"><?php echo ($productf2['productenname']); ?></p>

            </div>
            <div class="solution">
                <div class="col-xs-12 col-sm-6 computer traceability-img wow animated bounceInLeft" data-wow-duration="1.5s" data-wow-delay="0.2s">
                    <img src="<?php echo ($productf2['coverimg']); ?>" alt="">
                </div>
                <div class="col-xs-12 col-sm-6 traceability-con computer wow animated bounceInRight" data-wow-duration="1.5s" data-wow-delay="0.2s" >

                    <p><?php echo (htmlspecialchars_decode($productf2['describe'])); ?></p>
                </div>
...
<section class="page-section">
    <div class="container">
        <div class="text-content wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
            <h3 class="text-content-color h3-fear"><?php echo ($productf3['typename']); ?></h3>
            <p class="text-content-color p-fear"><?php echo ($productf3['describe']); ?></p>
        </div>
        <div class="solution wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
            <?php if(is_array($productf3['pro'])): foreach($productf3['pro'] as $k=>$vo): ?><div class="col-xs-12 col-sm-3 identify-borR">
                    <div class="equipment">
                        <img src="<?php echo ($vo['coverimg']); ?>" alt="">
                        <span><?php echo ($vo['productname']); ?></span>
                    </div>
