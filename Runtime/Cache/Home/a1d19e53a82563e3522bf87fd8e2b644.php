...
<!--The head of navigation-->
    ...
    <!--News center-->
    <script src="/Public/home/js/pageMe.js"></script>
    <script>
        (function($) {
            $.extend({
                myTime: {
    ...
    <script type="text/javascript">
        ...
        function product_data(page=1,limit=5) {
            var str = "";
            $.ajax({
                url: "<?php echo U('index/news_information');?>",
                    ...
                    if (data.count>0) {
                        ...
                        for (var i = 0; i < data.info.info.length; i++) {
                            ...
                            str+='<div class="col-xs-12 news-item wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">\n' +
                                ...
                                '                                <a href="<?php echo U('index/news_detail');?>?id='+data.info.info[i].id+'" class="news-btn view" data-id="about" >查看更多</a>\n' +
                                '                            </div>\n' +
                                '                        </div>\n' +
                                '                    </div>'
                        }
